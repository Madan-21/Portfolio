      ...
      <section id="projects" className="py-32 px-4 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <EnhancedProjectCard
              title="LMS Platform"
              description="A comprehensive Learning Management System with course creation, student tracking, and interactive learning modules. Built with modern web technologies for seamless educational experiences."
              url="#"
            ...
            <EnhancedProjectCard
              title="ConnectPC"
              description="An e-commerce platform for custom PC building with real-time configuration, compatibility checking, and personalized recommendations based on user needs and budget."
              url="#"
              technologies={["JavaScript", "MySQL", "CSS3", "HTML5"]}
              status="Development"
              gradient="from-purple-500 to-pink-500"
            />
            <EnhancedProjectCard
              title="Modern Portfolio"
              description="A responsive, interactive portfolio website featuring modern design principles, smooth animations, and optimized performance. Built to showcase projects and skills effectively."
              url="#"
